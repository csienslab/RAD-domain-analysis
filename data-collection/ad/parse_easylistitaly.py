...
lists = '''
easylistitaly/easylistitaly_adservers_popup.txt
easylistitaly/easylistitaly_adservers.txt
easylistitaly/easylistitaly_allowlist_dimensions.txt
easylistitaly/easylistitaly_allowlist_general_hide.txt
easylistitaly/easylistitaly_allowlist_popup.txt
easylistitaly/easylistitaly_allowlist.txt
easylistitaly/easylistitaly_general_block_popup.txt
easylistitaly/easylistitaly_general_block.txt
easylistitaly/easylistitaly_general_hide.txt
easylistitaly/easylistitaly_specific_block_popup.txt
easylistitaly/easylistitaly_specific_block.txt
easylistitaly/easylistitaly_specific_hide.txt
easylistitaly/easylistitaly_thirdparty_popup.txt
easylistitaly/easylistitaly_thirdparty.txt
easylistitaly/easylistitaly_adservers_popup.txt
easylistitaly/easylistitaly_adservers.txt
easylistitaly/easylistitaly_allowlist_dimensions.txt
easylistitaly/easylistitaly_allowlist_general_hide.txt
...
save_dir = Path('./history/easylistitaly')
