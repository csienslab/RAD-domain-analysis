...
lists = '''
easylistgermany/easylistgermany_adservers_popup.txt
easylistgermany/easylistgermany_adservers.txt
easylistgermany/easylistgermany_allowlist_dimensions.txt
easylistgermany/easylistgermany_allowlist_general_hide.txt
easylistgermany/easylistgermany_allowlist_popup.txt
easylistgermany/easylistgermany_allowlist.txt
easylistgermany/easylistgermany_general_block_popup.txt
easylistgermany/easylistgermany_general_block.txt
easylistgermany/easylistgermany_general_hide.txt
easylistgermany/easylistgermany_specific_block_popup.txt
easylistgermany/easylistgermany_specific_block.txt
easylistgermany/easylistgermany_specific_hide.txt
easylistgermany/easylistgermany_thirdparty_popup.txt
easylistgermany/easylistgermany_thirdparty.txt
'''.strip().splitlines()
...
save_dir = Path('./history/easylistgermany')
