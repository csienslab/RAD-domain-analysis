...
lists = '''
easylistspanish/easylistspanish_adservers_popup.txt
easylistspanish/easylistspanish_adservers.txt
easylistspanish/easylistspanish_allowlist_dimensions.txt
easylistspanish/easylistspanish_allowlist_general_hide.txt
easylistspanish/easylistspanish_allowlist_popup.txt
easylistspanish/easylistspanish_allowlist.txt
easylistspanish/easylistspanish_general_block_dimensions.txt
easylistspanish/easylistspanish_general_block_popup.txt
easylistspanish/easylistspanish_general_block.txt
easylistspanish/easylistspanish_general_hide.txt
easylistspanish/easylistspanish_specific_block_popup.txt
easylistspanish/easylistspanish_specific_block.txt
easylistspanish/easylistspanish_specific_hide.txt
easylistspanish/easylistspanish_thirdparty_popup.txt
easylistspanish/easylistspanish_thirdparty.txt
'''.strip().splitlines()
...
save_dir = Path('./history/easylistspanish')
